...
## 🚀 How to download and run new-macos-dev-setup
...
## ⚙️ What if the script does not run?
...
## 🔄 How to check progress and logs
...
## 🛠️ Updating new-macos-dev-setup
